...
func (s *WalletService) HistoryByProvider(ctx context.Context, req dto.WalletHistoryReq) ([]entity.WalletHistory, *errcode.ErrCode) {
	if err := req.Validate(); err != nil {
		return nil, err
	}
	if err := s.consumer.Validate(ctx, dto.ConsumerValidateReq{
		ConsumerId: req.ConsumerId,
		Method:     consumer_service.Method_WalletHistoryByProvider,
	}); err != nil {
		return nil, err
	}
