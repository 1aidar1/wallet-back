...
PATH_TO_FILE="wallet_storage.proto" # путь к файлу в гите (наример dir1/dir2/file.proto)
FILE_NAME="wallet_storage.proto" # название файла (наример file.proto)
...
OUTPUT_DIR="./pkg/proto/wallet_storage" # куда сохранить прото локально
